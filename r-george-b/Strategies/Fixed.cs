...
namespace RGeorgeB {
    public class Fixed : SlowSpectrumCycle {
        ...
        public Fixed(string? color) {
            var systemColour = typeof(System.Drawing.Color)
                .GetProperties(System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public)
                .FirstOrDefault(fi => string.Equals(fi.Name, color, StringComparison.OrdinalIgnoreCase))
            ...
            else if (!string.IsNullOrWhiteSpace(color) && color.TryParseFromHexString(out var fixedColour) && fixedColour != null) {
